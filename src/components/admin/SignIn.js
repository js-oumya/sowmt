...
export default function SignIn(props) {
  ...
  const handleClick=async()=>{
      var body={'emailid':adminId,'password':password}
      var list = await postData('signin/checklogin',body)
      if(list.length==1)
      {
          // alert("correct")
       console.log('ADMIN',props)
     // props.history.replace({pathname:`/Dashboard`,admin:list[0]}); 
       localStorage.setItem('admin',JSON.stringify({name:list[0].name}))
      ...
      <div className={classes.paper}>
        ...
        <Typography component="h1" variant="h5">
          ...
          <Grid container>
            ...
            <Grid item>
              <Link href="#" pathname="/UserRegistration" variant="body2">
